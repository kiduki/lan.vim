...
" Long-Ass Note
"
" Implementation module. Public entrypoints are exposed as lan#... functions.
...
function! lan#add_file(kind, text) abort
  call s:lan_add_file(a:kind, a:text)
endfunction
...
function! lan#toggle_done() abort
  call s:lan_toggle_done()
endfunction

function! lan#toggle_progress() abort
  call s:lan_toggle_progress()
endfunction

function! lan#toggle_waiting() abort
  call s:lan_toggle_waiting()
endfunction
